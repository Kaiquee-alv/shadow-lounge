...
import {
  AlertTriangle, ArrowDownRight, ArrowUpRight, ArrowRightLeft, BarChart3, Banknote, Beer, ChevronLeft,
...
function ReportsPage({ dashboard, history, from, to, setFrom, setTo }: any) {
  const periodProductUnits = history.reduce((sum: number, item: any) => sum + item.quantity, 0);
