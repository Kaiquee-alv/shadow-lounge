...
function SettingsPage({ products, rules, tableLimit, onCreateRule, onSetRuleActive, onDeleteRule, onUpdateTableLimit }: { products: any[]; rules: any[]; tableLimit: number; onCreateRule: (input: any) => void; onSetRuleActive: (input: any) => void; onDeleteRule: (input: any) => void; onUpdateTableLimit: (maxTables: number) => void }) {
